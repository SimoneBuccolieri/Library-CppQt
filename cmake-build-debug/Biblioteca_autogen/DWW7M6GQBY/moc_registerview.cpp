...
static constexpr auto qt_meta_stringdata_ZN12RegisterViewE = QtMocHelpers::stringData(
    "RegisterView",
    "loginRequested",
    "",
    "registerSuccess",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12RegisterViewE[] = {
...
Q_CONSTINIT const QMetaObject RegisterView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12RegisterViewE.offsetsAndSizes,
    qt_meta_data_ZN12RegisterViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12RegisterViewE_t,
        // Q_OBJECT / Q_GADGET
...
void RegisterView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (RegisterView::*)();
            if (_q_method_type _q_method = &RegisterView::loginRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (RegisterView::*)();
            if (_q_method_type _q_method = &RegisterView::registerSuccess; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *RegisterView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12RegisterViewE.stringdata0))

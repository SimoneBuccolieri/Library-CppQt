...
static constexpr auto qt_meta_stringdata_ZN19InitialFileSelectorE = QtMocHelpers::stringData(
    "InitialFileSelector"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19InitialFileSelectorE[] = {
...
Q_CONSTINIT const QMetaObject InitialFileSelector::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19InitialFileSelectorE.offsetsAndSizes,
    qt_meta_data_ZN19InitialFileSelectorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19InitialFileSelectorE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<InitialFileSelector, std::true_type>
    >,
    nullptr
} };
...
void *InitialFileSelector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19InitialFileSelectorE.stringdata0))

...
static constexpr auto qt_meta_stringdata_ZN8EditItemE = QtMocHelpers::stringData(
    "EditItem",
    "backRequested",
    "",
    "saveRequested",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8EditItemE[] = {
...
Q_CONSTINIT const QMetaObject EditItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8EditItemE.offsetsAndSizes,
    qt_meta_data_ZN8EditItemE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8EditItemE_t,
        // Q_OBJECT / Q_GADGET
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'eliminaRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'saveClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'eliminaClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'back'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
...
void EditItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &EditItem::backRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (EditItem::*)();
            if (_q_method_type _q_method = &EditItem::saveRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (EditItem::*)();
            if (_q_method_type _q_method = &EditItem::eliminaRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *EditItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8EditItemE.stringdata0))

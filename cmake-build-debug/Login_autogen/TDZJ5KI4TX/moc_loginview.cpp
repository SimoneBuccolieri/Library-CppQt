...
static constexpr auto qt_meta_stringdata_ZN9LoginViewE = QtMocHelpers::stringData(
    "LoginView",
    "registerRequested",
    "",
    "loginSuccess",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9LoginViewE[] = {
...
Q_CONSTINIT const QMetaObject LoginView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9LoginViewE.offsetsAndSizes,
    qt_meta_data_ZN9LoginViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9LoginViewE_t,
        // Q_OBJECT / Q_GADGET
...
void LoginView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (LoginView::*)();
            if (_q_method_type _q_method = &LoginView::registerRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (LoginView::*)();
            if (_q_method_type _q_method = &LoginView::loginSuccess; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *LoginView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9LoginViewE.stringdata0))
